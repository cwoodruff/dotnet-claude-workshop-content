...
/// <summary>
/// Sentence-aware chunker: packs whole sentences into ~ChunkSize-character windows with
/// ChunkOverlap characters carried into the next window, so context isn't cut mid-sentence.
/// </summary>
