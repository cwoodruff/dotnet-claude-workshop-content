...
/// <summary>
/// Docker-free fallback store. Holds vectors in memory and ranks by cosine similarity. Keeps the
/// demo working when Qdrant isn't available; not for production (no persistence, linear scan).
/// </summary>
