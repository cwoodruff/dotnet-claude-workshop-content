...
/// <summary>
/// Prompt-injection defense via structural separation — mirrors BookTracker.Api/Security/PromptSafety.cs.
/// Untrusted user text is sanitized and wrapped in a labeled &lt;user_input&gt; block placed in the USER
/// turn — never concatenated into the system prompt. The system prompt instructs the model to treat
