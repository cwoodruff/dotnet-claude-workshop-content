...
builder.Services.AddScoped<IAgentLlm, AnthropicAgentLlm>();
...
// Resolve caller identity + enforce per-user daily token budget on AI routes.
app.UseMiddleware<BookTracker.Api.Middleware.TokenBudgetMiddleware>();
