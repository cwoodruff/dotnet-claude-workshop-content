...
public class BookTrackerDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(a => a.Id);
            entity.Property(a => a.User).IsRequired().HasMaxLength(200);
            entity.Property(a => a.Feature).IsRequired().HasMaxLength(50);
            entity.Property(a => a.Model).IsRequired().HasMaxLength(100);
            entity.Property(a => a.CostUsd).HasColumnType("decimal(10,6)");
        });
