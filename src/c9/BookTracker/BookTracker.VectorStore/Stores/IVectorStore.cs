...
/// <summary>
/// Vector store abstraction. Two implementations: Qdrant (gRPC) and an in-memory fallback that keeps
/// the lab alive without Docker. Both compute cosine similarity.
/// </summary>
